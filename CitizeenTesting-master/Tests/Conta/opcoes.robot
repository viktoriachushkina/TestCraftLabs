...
User clicks on card named “Os meus locais”
    ...
    Sleep    6s
User clicks on card name “opções”
    Click Text       
    Sleep    2s
the page title should be “conta pessoal | Locais de Interesse”
    Sleep    1s
User should see text “opções”
    Wait Until Page Contains     Opções
User should see card named “Partilhar Publicação”
    Wait Until Page Contains    Apagar Publicação
User should see card named “Apagar Publicação”
    Wait Until Page Contains    Partilhar Publicação
User should see card named “Denunciar Publicação”
    Wait Until Page Contains    Denunciar Publicação
...
User clicks on “opções”
    ...
    User clicks on card named “Os meus locais”
    When User clicks on card name “opções”
