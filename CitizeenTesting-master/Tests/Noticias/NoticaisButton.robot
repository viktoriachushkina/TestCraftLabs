...
Scroll down the page
  #  [Arguments]  ${start_ratio}=0.8  ${end_ratio}=0.2
    # Assuming you already have a WebDriver session opened and a mobile app launched

    # Get the size of the screen
  #  ${size}=  [0,0][1080,1977]

    # Set start and end coordinates for the swipe
  #  ${start_x}=  Evaluate  ${size['[55,1087]'] / 2}
  #  ${start_y}=  Evaluate  ${size['[508,1201]'] * ${start_ratio}}
  #  ${end_x}=  Evaluate  ${size['[55,1201]'] / 2}
  #  ${end_y}=  Evaluate  ${size['[1025,1325]'] * ${end_ratio}}
