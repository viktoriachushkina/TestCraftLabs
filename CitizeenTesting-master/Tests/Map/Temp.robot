...
When User clicks on card named "Temp."
     Click Text      TEMP
Then User should see card named "ver mais comfort termico"
    Sleep    5s
    Wait Until Page Contains    Ver mais conforto térmico

User should see card "indicetemp1"
    Sleep    3s
User clicks on "ver mais conforto termico":
